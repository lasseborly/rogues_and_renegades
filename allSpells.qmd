...
A portal to one of the Elemental Planes of Air, Earth, Fire, or Water is opened, allowing the Wizard to summon an elemental from that plane. Review the [Elemental](monstersAll.qmd#elemental) entry in the
...
weapons it will find that it is unstable. Attacks are made
with disadvantage. This does not usually affect spellcasting
...
portal without ending the spell, as can a Wizard
