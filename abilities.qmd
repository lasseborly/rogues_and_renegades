...
**Intelligence:** This is the ability to learn and apply knowledge. Intelligence is the Prime Requisite for [Wizards](class.qmd#wizards). The ability bonus for Intelligence is added to the number of [languages](abilities.qmd#languages) the character is able to learn to read and write; if the character has an Intelligence penalty, he or she cannot read more than a word or two, and will only know his or her native language.
...
**Dexterity:** This ability measures the character's quickness and balance as well as aptitude with tools. The Dexterity bonus or penalty is applied to all [attack rolls](combat.qmd#attacking-maneuvers) with missile (ranged) weapons, to the character's [Armor Class](equipment.qmd#armor-and-shields) value, and to the character's [Initiative](combat.qmd#initiative) die roll.
