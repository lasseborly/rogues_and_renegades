...
Nobles are usually (70%) normal men; otherwise, roll 1d10: 1-6 indicates a Fighter, 7-8 indicates a Wizard, 9 indicates a Cleric, and 10 indicates a Thief. (Clerical "nobles" are bishops, archbishops, and the like.) Roll 2d4-1 for the level of each "classed" noble.
...
**Wizards:** These characters are simply untrained in any weapon other than those normally allowed to them, and should suffer a -5 attack penalty when using any prohibited weapon. A Wizard in armor can't cast spells at all; any such attempt fails, and the spell is lost.
