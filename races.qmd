...
**Restrictions:** Dwarves may become [Clerics](class.qmd#cleric) or [Fighters](class.qmd#fighter). They are required to have a minimum Constitution of 9. Due to their generally dour dispositions, they may not have a Charisma higher than 17. They may not employ Large weapons more than four feet in length (specifically, two-handed swords, polearms, and longbows).
...
**Restrictions:** Elves may become [Clerics](class.qmd#cleric), [Fighters](class.qmd#fighter), or [Wizards](class.qmd#wizards); they are also allowed to combine the classes of Fighter and Wizard (see Warlock in [Combination Classes](class.qmd#combination-classes)). They are required to have a minimum Intelligence of 9. Due to their generally delicate nature, they may not have a Constitution higher than 17. Elves never roll larger than six-sided dice (d6) for hit points.

**Special Abilities:** All Elves have [Darkvision](dungeonAdventures.qmd#darkvision) with a 60' range. They are able to find secret doors more often than normal (2 in 6 rather than the usual 1 in 6). An Elf is so observant that one has a 1 in 6 chance to find a secret door with a cursory look. Elves are immune to the paralyzing attack of ghouls. Also, they are less likely to be surprised in combat, reducing the chance of surprise by 1 in 1d6.
