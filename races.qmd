...
**Restrictions:** Elves may become [Clerics](class.qmd#cleric), [Fighters](class.qmd#fighter), [Wizards](class.qmd#wizards), or [Thieves](class.qmd#thief); they are also allowed to combine the classes of Fighter and Wizard, and of Wizard and Thief (see [Combination Classes](class.qmd#combination-classes)). They are required to have a minimum Intelligence of 9. Due to their generally delicate nature, they may not have a Constitution higher than 17. Elves never roll larger than six-sided dice (d6) for hit points.
