...
This supplement provides information for playing Illusionists, a form of “specialist” Wizard, under the Basic Fantasy Role-Playing Game rule system. If you do not already have a copy of the Basic Fantasy RPG Core Rules, please visit the website and download a copy.
...
Illusionists are "specialist" Wizards who focus on the creation and manipulation of illusions, whether visual, auditory, or mental, and at higher levels quasi-real things made of tangible shadow. Though "normal" Wizards can create illusions, those created by a true Illusionist are superior in quality and realism.

The Prime Requisite for an Illusionist is Intelligence. The Illusionist is required to have an Intelligence score of 13 or higher. Illusionists are poor fighters, with fighting ability equivalent to normal Wizards. Likewise they are no more hardy than standard Wizards (d4 hit die). They may not wear any armor of any sort or use shields. Like other Wizards, they can utilize a walking staff (or cudgel) or dagger, and of course they may use magical weapons of those types. Otherwise, Illusionists can generally be treated as equivalent to Wizards for any situation not covered here.
...
Illusionists follow the rules for wizards for making magic items. Illusionists may make spell scrolls and any magic items on this page, as well as any other items the GM feels are appropriate.
