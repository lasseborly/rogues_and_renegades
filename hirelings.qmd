...
**Alchemist:** *1,000 gp per month.*These characters are generally hired for one of two reasons: to make potions, or to assist a Wizard with magical research.

An alchemist can produce a potion, given the required materials and a sample or a written formula for the potion, in the same time and for the same cost as a Wizard. They may also research new potions, but at twice the cost in time and materials as a Wizard. Review the rules for [Magical Research](gm01.qmd#magical-research) for details.

Alternately, a Wizard seeking to create certain magic items may employ an alchemist as an assistant. In this case, the alchemist adds 15% to the Wizard's chance of success.
